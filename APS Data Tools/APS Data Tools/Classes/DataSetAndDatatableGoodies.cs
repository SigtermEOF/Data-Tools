...
namespace Studio5Groups
{
    class DataSetAndDatatableGoodies
    {
        ...
        public void InsertRecordsIntoTables(DataSet dSetAllTheGoodies)
        {
            try
            {
        ...
        public void ClearDP2Records(DataSet dSetAllTheGoodies)
        {
            try
            {
                ...
                // Delete Orders data. //Commented out due to updating the order data if it exists.

                #region Commented code

                //DataTable dTblCheckForOrderData = new DataTable("dTblCheckForOrderData");
                //string sCommText02 = "SELECT * FROM [Orders] WHERE [ID] = '" + sRefNum + "'";

                //DBConnGoodies03.SQLQuery(sDP2ConnString, sCommText02, dTblCheckForOrderData);

                //if (dTblCheckForOrderData.Rows.Count > 0)
                //{
                //    bool bOrderDataDeletionSuccess = false;
                //    sCommText02 = "DELETE FROM [Orders] WHERE [ID] = '" + sRefNum + "'";

                //    DBConnGoodies03.SQLNonQuery(sDP2ConnString, sCommText02, ref bOrderDataDeletionSuccess);

                //    if (bOrderDataDeletionSuccess == true)
                //    {

                //    }
                //    else if (bOrderDataDeletionSuccess != true)
                //    {
                //        string sStop = string.Empty;
                //    }
                //}
                //else if (dTblCheckForOrderData.Rows.Count == 0)
                //{

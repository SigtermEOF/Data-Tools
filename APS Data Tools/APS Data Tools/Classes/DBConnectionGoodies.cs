...
namespace Studio5Groups
{
    ...
    {
        string sCDSConnString = Studio5Groups.Properties.Settings.Default.CDSConnString.ToString();
        string sDP2ConnString = Studio5Groups.Properties.Settings.Default.DP2ConnString.ToString();
